...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/b_Time (1)'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/b_My Info'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/b_Dashboard (1)'))

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/a_Welcome Paul (1)'))
